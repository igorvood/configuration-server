...
as $$
    declare
    l_graph_id  varchar(256);
    l_SERVICE_ID varchar(256);
    l_PROFILE_ID varchar(256);
    l_MAIN_CLASS varchar(256);
    l_topics topic[];
    l_propperties PROPERTy[];
begin
    l_graph_id   := 'very_big';
    ...
    select dirrection, topic_name, prop_name INTO l_topics
    from t;
    ...
    select prop_id, prop_value, is_function into l_propperties from p;
