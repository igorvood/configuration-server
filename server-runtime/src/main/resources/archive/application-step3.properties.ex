...
mdm-enrichment.service.name=mdm-enrichment-step3
...
mdm-enrichment.enrichOne.MainEnrichProperty$.fromTopic=dev_bevents__realtime__enrichment__prof__mdm_id__uaspdto
