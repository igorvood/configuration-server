mdm-enrichment.service.name=mdm-enrichment-full
...
mdm-enrichment.producer.property.transactional.id=enrichment_transactional_id_full
...
mdm-enrichment.enrichOne.RateEnrichProperty$.toTopicName=dev_ivr__uasp_realtime__outer_cbr_rate__ask
...
mdm-enrichment.enrichOne.RateEnrichProperty$.depthOfDay=2
mdm-enrichment.enrichOne.RateEnrichProperty$.enrichRatesCurrencyAlphaCodeFieldName=rates_currency_numericCode
mdm-enrichment.enrichOne.RateEnrichProperty$.enrichCurrencyDateFieldName=currency_date
