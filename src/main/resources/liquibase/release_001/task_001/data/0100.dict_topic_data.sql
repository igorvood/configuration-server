...
select 'Filter_producer_1', 'DESCRIPTION', 1, 'dev_ivr__Filter_producer_1__uaspdto', null, 'DEFAULT_PRODUCER', 'DEFAULT_CONSUMER' from dual union all
select 'Filter_producer_2', 'DESCRIPTION', 1, 'dev_ivr__Filter_producer_2__uaspdto', null, 'DEFAULT_PRODUCER', 'DEFAULT_CONSUMER' from dual union all
