...
select 'Mutator', 'case_65', 'in', 'uasp_mutator_filter_input_2', 'DEFAULT_CONSUMER' from dual union all
...
select 'Additional_enrich', 'case_65', 'in', 'ivr__uasp_realtime__bussiness_rules__uaspdto__dlq', 'DEFAULT_CONSUMER' from dual  UNION ALL
select 'Additional_enrich', 'case_65', 'out', 'mutator_consumer_2', 'DEFAULT_PRODUCER' from dual  UNION ALL
