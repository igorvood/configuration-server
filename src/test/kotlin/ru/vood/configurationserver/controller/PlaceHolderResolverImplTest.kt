...
internal class PlaceHolderResolverImplTest {
    ...
    fun placeHolders() {
        ...
        val listOf =
            listOf(EnvProperty("somePropertyName", "\${$placeHolder_1}___\${$placeHolder_2}_some_letters", 1, ""),
                    EnvProperty("somePropertyName", "\${$placeHolder_1}___\${$placeHolder_3}_some_letters", 1, "")
            )

        val placeHolders = placeHoldersResolverImpl.placeHolders(listOf, FlinkServiceProfile(FlinkService("id_flinkService", "SomeMain"), "profileId"))
