...
select a.SERVICE_ID, a.PROFILE_ID, a.stand, a.placeholder_id, nvl(ph_srv.VALUE, a.DEFAULT_VALUE) placeholder_value
from a
...
/
comment on table resolvable_placeholder is 'Разрешенне значения пленйсхолдеров.'
/
