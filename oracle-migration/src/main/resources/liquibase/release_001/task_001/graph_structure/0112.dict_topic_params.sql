...
(
  ...
  constraint dict_topic_params_by_stand_st_fk foreign key (stand_id) references META_STAND(id),
  constraint dict_topic_params_by_stand_pk primary key (stand_id, id) using index tablespace t_idx,
...
/
comment on column dict_topic_params_by_stand.id is 'Идентификатор топика.'
/
